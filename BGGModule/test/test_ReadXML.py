...
class ReadXMLTests(unittest.TestCase):
    ...
    xml_data[1].players = [
        ...
        PlayerXMLDataset(username="", userid=0, name="Arden", startposition=5, colour="",
                         score=0, new=False, rating=0, won=True),
